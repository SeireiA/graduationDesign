"use strict";
const components_mpHtml_components_mpHtml_latex_katex_min = require("./katex.min.js");
function Latex() {
}
    ...
    node.children = node.text.split("$").map((str, index) => {
      if ((index + 1) % 2 === 0) {
        return {
          ...
          children: components_mpHtml_components_mpHtml_latex_katex_min.parse.default(str)
        };
      }
      return {
        type: "text",
